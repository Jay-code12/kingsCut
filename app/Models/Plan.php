...
class Plan
{
     ...
     * (past or present) references it, since deleting that would corrupt
     * the customer's membership/payment history — the admin should
     * deactivate a plan (e.g. via custom pricing / low sort order) instead
     * of deleting one that's actually been sold.
     */
